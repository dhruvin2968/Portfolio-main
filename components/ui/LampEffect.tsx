...
// Updated LampDemo to accept custom text via props
export function LampDemo({ text }: { text: string }) {
  return (
    <LampContainer>
      <motion.h1
        ...
        className="bg-gradient-to-br from-slate-300 to-slate-500 py-2 bg-clip-text text-center text-3xl tracking-tight text-transparent md:text-6xl font-bold"
      >
        {text}
      </motion.h1>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0 gap-0",
        className
      )}
    >
